...
/*
* Linerlayout1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                img_list.get(0).setImageResource(R.mipmap.thunder);
                img_list.get(1).setImageResource(R.mipmap.dance_unclick);
        ...
        Linerlayout2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                img_list.get(0).setImageResource(R.mipmap.thunder_unclick);
                img_list.get(1).setImageResource(R.mipmap.dance);
        ...
        Linerlayout3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                img_list.get(0).setImageResource(R.mipmap.thunder_unclick);
                img_list.get(1).setImageResource(R.mipmap.dance_unclick);
        ...
        Linerlayout4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                img_list.get(0).setImageResource(R.mipmap.thunder_unclick);
                img_list.get(1).setImageResource(R.mipmap.dance_unclick);
